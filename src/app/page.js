...
import ProjectComponet from "@/components/Project/ProjectComponet";
...
export const HomeComponent = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row-reverse items-center mx-auto justify-evenly gap-12 p-8 h-screen w-full ">
      ...
      <section className="text-center md:text-left">
        ...
        <p className="text-sm text-gray-400 max-w-lg mx-auto md:mx-0">
          ...
          Node.js), Next.js, and AI/ML integration. My goal? To turn ideas into
          powerful, scalable solutions with modern UI, automation, and
          cutting-edge AI.
        </p>
        ...
        <button className="bg-cyan-400 text-gray-900 font-semibold text-lg px-4 py-2 rounded-md mt-6 flex justify-center items-center gap-2">
          Download CV
          <FaFileDownload />
        </button>
      </section>
